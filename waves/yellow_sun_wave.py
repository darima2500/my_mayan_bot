wave_info = {
    ...
    "period": {
        "en": "June 16 — June 28, 2025",
        "ru": "16 июня — 28 июня 2025"
    },
...
Тень: Гордыня, отказ воспринимать обратную связь
    ...
    "description": {
        ...
        "ru": (
            "Эта волна несёт энергии просветления, безусловной любви, божественной игры и глубокой связи с Истоком и Предками.\n\n"
            "Жёлтое Солнце приглашает вспомнить сияющую искру внутри — священный свет, который соединяет тебя со всей жизнью.\n"
            "Это время празднования целостности, воплощения любви без условий и сотворения красоты, поэзии и радости в потоке бытия.\n\n"
            "Солнце учит: истинное просветление — это жизнь в благодати бытия, смиренное участие в танце жизни с сердцем Творца."
        )
    },
    "archetype": {
