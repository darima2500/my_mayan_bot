...
wave_info = {
    ...
    "description": {
        ...
        "ru": (
            "Эта волна несёт энергии исследования, связи и духовного наставничества.\n\n"
            "Красный Небесный Странник приглашает идти как мост между мирами — глубоко укореняясь в Земле и одновременно стремясь к бесконечному небу.\n"
