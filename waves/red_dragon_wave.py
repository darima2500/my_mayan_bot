wave_info = {
    ...
    "description": {
        ...
        "ru": (
            ...
            "Внимательно соушайте любой импульс, который рождается на уровне Души, не пропускайте его и сделайте любой, даже самый маленький, но всё-таки отклик в виде действия, шага к исполнение нового."
        )
    }
}
