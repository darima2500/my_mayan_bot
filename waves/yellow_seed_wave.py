wave_info = {
    ...
    "description": {
        ...
        "ru": (
            "Эта волна несёт энергии роста, потенциала и осознанного взращивания.\n\n"
            "Жёлтое Семя приглашает укорениться там, где ты можешь процветать — питать свои мечты с терпением и доверять естественному темпу роста.\n"
            "Это время укреплять свои корни, строить значимые связи и позволять своим дарам созревать.\n\n"
            "Семя напоминает: настоящее процветание рождается не через усилие, а через создание условий для естественного раскрытия жизни."
        )
    },
    "archetype": {
