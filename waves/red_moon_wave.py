wave_info = {
    ...
    "description": {
        ...
        "ru": (
            ...
            "Красная Луна учит, что настоящая сила рождается в свободном течении эмоций без сопротивления.\n"
            "Это время доверять внутренним водам, находить баланс между отдачей и принятием, почитать приливы внутри себя.\n\n"
            "Когда ты соединяешься со священным течением жизни, исцеление и ясность приходят естественным образом."
        )
    },
    "archetype": {
