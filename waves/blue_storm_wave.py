wave_info = {
    ...
    "core_themes": {
        ...
        "ru": [
            ...
            "Перерождение через отпускание",
            "Тень: Хаос, эмоциональное перенасыщение"
        ]
    },
    "description": {
        "en": (
        ...
        "ru": (
            "Эта волна несёт энергии трансформации, очищения и священной силы перерождения.\n\n"
            "Голубой Шторм приглашает сдаться силам перемен — позволить старым структурам раствориться, чтобы на их месте родились новая ясность и жизненность.\n"
            "Это время интенсивной чистки, эмоционального катарсиса и глубокой перенастройки с истинной сутью.\n\n"
            "Шторм учит: истинное очищение — это не разрушение ради разрушения, а священный огонь, который освобождает путь для новой жизни."
        )
    },
    "archetype": {
